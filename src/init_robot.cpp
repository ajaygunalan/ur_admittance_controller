...
public:
  ...
  EquilibriumInitializer() : Node("equilibrium_initializer") {
    // Declare parameters
    this->declare_parameter("equilibrium.position", std::vector<double>{0.1, 0.4, 0.5});
    this->declare_parameter("equilibrium.orientation", std::vector<double>{0.0, 0.0, 0.0, 1.0});
...
private:
  ...
  std::vector<double> equilibrium_positions_;
